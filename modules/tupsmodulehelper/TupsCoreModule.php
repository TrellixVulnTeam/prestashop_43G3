...
if (!class_exists('\Helper\UploadHelper', false)) {
    include_once __DIR__ . '/classes/Helper/UploadHelper.php';
}

if (!class_exists('\Helper\ScanDir', false)) {
    include_once __DIR__ . '/classes/Helper/ScanDir.php';
}

class TupsCoreModule extends \Module
{
